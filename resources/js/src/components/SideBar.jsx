...
const navigation = [
  ...
  { name: 'Menu', href: '/admin/menu', icon: InboxIcon, current: false },
  { name: 'Orders', href: '/admin/orders', icon: FolderIcon, current: false },
  { name: 'Kds', href: '/admin/kds', icon: ChartBarIcon, current: false },
]
          ...
          <div className="flex min-h-0 flex-1 flex-col bg-gray-800">
            <div className="flex h-16 flex-shrink-0  items-center bg-gray-900 px-4">
              <img
                ...
                alt="Your Company"
              />
              <p className='text-[#1aaaab] text-xl'>Amani Caffe</p>
            </div>
